      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        >
          <RowTwoCols
            ...
            rightLabel="Tipo de Venta"
            rightValue={orden.tipo_venta}
          />
          <RowTwoCols
            leftLabel="Fecha de Venta"
            leftValue={orden.fecha_venta1}
            rightLabel="Mercado"
            rightValue={orden.mercado}
          />
          <RowTwoCols
            leftLabel="Fecha de Solicitud"
            leftValue={orden.fecha}
            rightLabel="Peso Promedio"
            rightValue={orden.peso_promedio}
          />
          <RowBadge
            label="Estado"
            value={orden.estado}
