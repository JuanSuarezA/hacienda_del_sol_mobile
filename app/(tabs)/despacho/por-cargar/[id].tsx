...
interface Transporte {
  ...
  estado: string;
  n: string;
  // Nuevos campos según tu lógica de PHP:
  entrada: string; // "SI" o "NO"
  estado_id: number;
}
...
const OrdenesCompraScreen = () => {
  ...
  const fetchOrdenes = async () => {
    try {
      setLoading(true);
      const baseUrl = "https://kleurdigital.xyz/util/carga-od";
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.headerContainer}>
        <View style={styles.topRow}>
          <Link style={styles.backButton} href={"/despacho/por-cargar"}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        >
          {transporte.map((item) => {
            ...
            const mostrarCheckbox = item.estado_id === 81;
            const estaDeshabilitado = item.entrada !== "SI";
